...
<div class="container" style="margin-top: 50px">
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <form action="{{ route('file.compare.hash') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
                    ...
                    <label  style="margin-top: 30px" class="form-label">Выберите файл для сравнения (хеш) </label>
